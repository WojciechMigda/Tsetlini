...
{
    auto const clf = Tsetlini::make_regressor_bitwise(R"({"s": -1.0})");
...
{
    auto const clf = Tsetlini::make_regressor_bitwise(R"({"s": 0.0})");
...
{
    auto const clf = Tsetlini::make_regressor_bitwise(R"({"s": 0.999})");
...
{
    auto const clf = Tsetlini::make_regressor_bitwise(R"({"s": -inf})");
...
{
    auto const clf = Tsetlini::make_regressor_bitwise(R"({"s": NaN})");

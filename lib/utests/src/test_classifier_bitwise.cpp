...
"ClassifierBitwise can be created with counting_type argument set to int8"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::counting_type_t{"int8"})
...
"ClassifierBitwise can be created with counting_type argument set to int16"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::counting_type_t{"int16"})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with counting_type argument set to int32"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::counting_type_t{"int32"})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with counting_type argument set to auto"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::counting_type_t{"auto"})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with clause_output_tile_size argument set to 16"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::clause_output_tile_size_t{16})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with clause_output_tile_size argument set to 32"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::clause_output_tile_size_t{32})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with clause_output_tile_size argument set to 64"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::clause_output_tile_size_t{64})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with clause_output_tile_size argument set to 128"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::clause_output_tile_size_t{128})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise cannot be created with number_of_jobs argument set to 0"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::number_of_jobs_t{0});

    expect(that % false == !!clf);
};


"ClassifierBitwise cannot be created with number_of_jobs argument set to -2"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::number_of_jobs_t{-2});
...
"ClassifierBitwise cannot be created with number_of_physical_classifier_clauses_per_label argument set to 3"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::number_of_physical_classifier_clauses_per_label_t{3});

    expect(that % false == !!clf);
};


"ClassifierBitwise cannot be created with number_of_physical_classifier_clauses_per_label argument set to 2"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::number_of_physical_classifier_clauses_per_label_t{2});

    expect(that % false == !!clf);
};


"ClassifierBitwise cannot be created with number_of_physical_classifier_clauses_per_label argument set to 1"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::number_of_physical_classifier_clauses_per_label_t{1});

    expect(that % false == !!clf);
};


"ClassifierBitwise cannot be created with number_of_physical_classifier_clauses_per_label argument set to 0"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::number_of_physical_classifier_clauses_per_label_t{0});
...
"ClassifierBitwise cannot be created with number_of_physical_classifier_clauses_per_label argument set to -4"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::number_of_physical_classifier_clauses_per_label_t{-4});
...
"ClassifierBitwise cannot be created with number_of_states argument set to 0"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::number_of_states_t{0});

    expect(that % false == !!clf);
};


"ClassifierBitwise cannot be created with number_of_states argument set to -1"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::number_of_states_t{-1});

    expect(that % false == !!clf);
};


"ClassifierBitwise can be created with boost_true_positive_feedback argument set to true"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::boost_tpf_t{true})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with boost_true_positive_feedback argument set to false"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::boost_tpf_t{false})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with threshold argument set to 1"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::threshold_t{1})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise cannot be created with threshold argument set to 0"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::threshold_t{0});

    expect(that % false == !!clf);
};


"ClassifierBitwise cannot be created with threshold argument set to -1"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::threshold_t{-1});

    expect(that % false == !!clf);
};


"ClassifierBitwise can be created with max_weight argument set to 1"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::max_weight_t{1})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with max_weight argument set to 10"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::max_weight_t{10})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise cannot be created with max_weight argument set to 0"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::max_weight_t{0});

    expect(that % false == !!clf);
};


"ClassifierBitwise cannot be created with max_weight argument set to -1"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::max_weight_t{-1});

    expect(that % false == !!clf);
};


"ClassifierBitwise can be created with verbosity argument set to true"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::verbosity_t{true})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with verbosity argument set to false"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::verbosity_t{false})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with weighted argument set to true"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::weighted_flag_t{true})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with weighted argument set to false"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::weighted_flag_t{false})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise cannot be created with specificity argument set to -1.0"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::specificity_t{-1.0});

    expect(that % false == !!clf);
};


"ClassifierBitwise cannot be created with specificity argument set to 0.0"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::specificity_t{0.0});

    expect(that % false == !!clf);
};


"ClassifierBitwise cannot be created with specificity argument set to 1.0 - epsilon"_test = []
{
...
"ClassifierBitwise cannot be created with specificity argument set to -inf"_test = []
{
    using underlying_type = strong::underlying_type_t<Tsetlini::specificity_t>;

    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::specificity_t{-std::numeric_limits<underlying_type>::infinity()});
...
"ClassifierBitwise cannot be created with specificity argument set to +NaN"_test = []
{
    auto const clf = Tsetlini::make_classifier_bitwise(Tsetlini::specificity_t{NAN});
...
"ClassifierBitwise can be created with specificity argument set to 1.0"_test = []
{
    using underlying_type = strong::underlying_type_t<Tsetlini::specificity_t>;

    Tsetlini::make_classifier_bitwise(Tsetlini::specificity_t{1.0})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with specificity argument set to 3.14"_test = []
{
    using underlying_type = strong::underlying_type_t<Tsetlini::specificity_t>;

    Tsetlini::make_classifier_bitwise(Tsetlini::specificity_t{3.14})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with random_seed argument set to 1"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::random_seed_t{1})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
...
"ClassifierBitwise can be created with random_seed argument set to 1234"_test = []
{
    Tsetlini::make_classifier_bitwise(Tsetlini::random_seed_t{1234})
        .leftMap([](Tsetlini::status_message_t && msg)
            {
                expect(false);
